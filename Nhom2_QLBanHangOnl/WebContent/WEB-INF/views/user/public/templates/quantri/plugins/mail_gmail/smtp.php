...
function SendMail($server,$taikhoan,$matkhau,$frommail,$tomail,$subject,$message,$fromfullname="Webmau.vn")
{
      ...
      $smtp_host =$server;//Dia chi mail server
      $admin_email = $taikhoan;//User duoc khai bao tren mail server
      $smtp_username = $taikhoan;//User duoc khai bao tren mail server
      $smtp_password = $matkhau;//Pass cua email nay
...
//Test send mail
//SendMail("info@webmau.vn","vcthth@gmail.com","Chào "," Noi dung ");
