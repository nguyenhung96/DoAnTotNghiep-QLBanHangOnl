					...
					<form:form>
						<table>
							<tr class="form-group">
								...
								<td><form:label path="maNhanVien" class="col-sm-4">Mã nhân viên: </form:label>
								</td>
								<td><form:label path="maNhanVien" class="col-sm-4">${nhanvien.maNhanVien}</form:label></td>
							</tr>
							<tr class="form-group">
								<td><form:label for="lblmaSP" path="hoTenNV"
										class="col-sm-4">Tên nhân
										viên: </form:label></td>
								<td><form:label for="lblmaSP" path="hoTenNV"
										class="col-sm-4">${nhanvien.hoTenNV}</form:label></td>
							</tr>
							<tr class="form-group">
								<td><form:label for="lbltenSP" path="gioiTinhString"
										...
										tính: </form:label></td>
								<td><form:label for="lbltenSP" path="gioiTinhString"
										class="col-sm-4 text">${nhanvien.gioiTinhString}</form:label></td>
							</tr>
							<tr class="form-group">
								<td><form:label for="lbltenSP" path="SDT" class="col-sm-4">Số điện thoại</form:label></td>
								<td><form:label for="lbltenSP" path="SDT"
										class="col-sm-4 text">${nhanvien.SDT}</form:label></td>
							</tr>
							<tr class="form-group">
								<td><form:label for="lbltenSP" path="diaChi"
										class="col-sm-4">Địa chỉ</form:label></td>
								<td><form:label for="lbltenSP" path="diaChi"
										class="col-sm-4 text">${nhanvien.diaChi}</form:label></td>
							</tr>
							<tr class="form-group">
								<td><form:label for="lblthongTinSP" path="matKhau"
										...
										khẩu:</form:label></td>
								<td>
									<button class="btn btn-mini btn-primary col-sm-4">Đổi
										mật khẩu</button>
								</td>
							</tr>
							<tr class="form-group">
								<td><form:label for="lblgia" path="quyenNV" class="col-sm-">Nhóm người
										dùng:</form:label></td>
								<td><form:label for="lblgia" path="quyenNV"
										class="col-sm-4">Admin</form:label></td>
							</tr>
							<tr>
								<td><a style="float: right; margin-right: 35px;"
