					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<form:form method="POST"
								action="/Nhom2_QLBanHangOnl/home/saveproducttype.do">
								<table>

									<tr class="form-group col-md-11">
										<td class="col-md-3"><form:label path="Id">STT</form:label></td>
										<td class="col-md-5"><form:input path="Id"
												class="form-control " value="${nhomsanpham.id}" /></td>
									</tr>
									...
									<tr class="form-group col-md-11">
										...
										<td class="col-md-5"><form:input class="form-control "
												path="tenNhomSP" value="${nhomsanpham.tenNhomSP}" /></td>
									</tr>
