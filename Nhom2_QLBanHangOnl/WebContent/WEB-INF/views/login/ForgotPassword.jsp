		...
		<div class="container-login100"
			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form:form class="login100-form validate-form"
					action="/Nhom2_QLBanHangOnl/login/quenmatkhaumail.do" method='POST'
					onsubmit="return checklogin()">
					<table>
						<span class="login100-form-title p-b-49"> Nhập mã nhân viên
							để tiếp tục </span>

						<tr class="wrap-input100 validate-input m-b-23">
							<td><form:label class="label-input100" path="maNhanVien">Mã nhân viên</form:label></td>
							<td><form:input id="ID" class="input100" type="text"
									path="maNhanVien" value="${nhanvien.maNhanVien}"/></td>
